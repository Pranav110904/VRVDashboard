...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-[#222361] text-[#222]">
      {/* Sidebar */}
      ...
      <Routes>
        ...
        <Route path="users" element={<Users />} /> {/* Manage Users */}
        <Route path="users/adduser" element={<AddUser />} /> {/* Add User */}
        <Route path="roles" element={<Roles />} />
        <Route path="roles/addrole" element={<AddRole />} /> {/* Add User */}
