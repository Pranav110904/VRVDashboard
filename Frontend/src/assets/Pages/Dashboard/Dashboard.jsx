...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col font-raleway md:flex-row h-screen bg-[#222361] text-[#222]">
          ...
          <div className="w-full flex flex-col justify-between h-full">
            <div>
              ...
              <div className="flex justify-between items-center py-5 mb-5">
                ...
                >
                  {isMenuOpen ? <MdClose size={24} /> : <RiMenu4Fill size={24}  />}
                </button>
              </div>
      ...
      {/* Main content area */}
      <main className={`
        flex-1 px-4 md:px-10 font-raleway py-5 md:mt-0 text-white relative 
      ...
      `}>
        ...
        <div className="md:hidden flex justify-between items-center mb-4 px-2">
          <div className="flex items-center gap-2">
            <SiDeepcool color="#5154da" size={30} />
            <span className="font-bold text-lg">LOGO</span>
          </div>
          <div>
            <img src={face} className="rounded-full w-8 h-8" alt="Profile" />
          </div>
        </div>

        <div className="bg-white rounded-2xl p-4 md:p-6 font-raleway mt-4 font-bold text-lg md:text-xl lg:text-2xl flex flex-col md:flex-row md:items-center gap-3 mb-10">
